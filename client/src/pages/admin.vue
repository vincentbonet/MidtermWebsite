      ...
      <div class="bg-gray-700 p-6 shadow-md rounded-md"> 
        ...
        <form @submit.prevent="addNewUser" class="space-y-4">
          <div class="flex flex-col">
            ...
            <label for="isAdmin" class="font-semibold mb-1">Admin:</label>
            <input type="checkbox" v-model="newUser.isAdmin" id="isAdmin" class="input-field bg-gray-800 text-gray-200">
          </div>
